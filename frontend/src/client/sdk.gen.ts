...
export class AccessService {
    ...
    public static listLogs(data: AccessListLogsData = {}): CancelablePromise<AccessListLogsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
